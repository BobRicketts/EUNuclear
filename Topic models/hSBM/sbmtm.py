...
class sbmtm():
    ...
    def fit(self,overlap = False, n_init = 1, niter=1, merge_sweeps=10, mh_sweeps=10, gibbs=False, verbose=False, epsilon=1e-3):
        '''
            ...
            for i_n_init in range(n_init):
                ...
                state_tmp = gt.minimize_nested_blockmodel_dl(g,
                                                            ...
                                                            multilevel_mcmc_args=dict(
                                                                 verbose=verbose,
                                                                 niter=niter,
                                                                 merge_sweeps=merge_sweeps,
                                                                 mh_sweeps=mh_sweeps,
                                                                 gibbs=gibbs)) # changed to mcmc_multilevel_args at one point
                L = 0
